          ...
          <div class="col-md-12 mb-2 justify-content-center">
            <form action="" id="find-car">
              <div class="row form-group">
                <div class="col-md-4">
                  <label for="" class="control-label text-white">Jam/Tanggal Penjemputan</label>
                  <input type="text" class="form-control datetimepicker" required="" name="pickup" autocomplete="off">
                </div>
                <div class="col-md-4">
                  <label for="" class="control-label text-white">Jam/Tanggal Pengembalian</label>
                  <input type="text" class="form-control datetimepicker" required="" name="dropoff" autocomplete="off">
                </div>
                <div class="col-md-4">
                  <label for="" class="control-label text-white">Kategori</label>
                  <select class="custom-select select2">
                    <option value="0">Pelaminan/Baju Adat</option>
                    <?php
              ...
              <div class="form-group ">
                <center>
                  <button class="btn btn-primary">Temukan Tenda Pelaminan dan Baju adat</button>
                </center>
              </div>
            </form>
          </div>
...
<body id="page-top">
  ...
  <footer class=" py-5">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8 text-center">
          <h2 class="mt-0 text-white">Hubungi Kami</h2>
          <hr class="divider my-4" />
        </div>
      </div>
      <div class="row">
    ...
    <br>
    <div class="container">
      <div class="small text-center text-muted"> © 2024 - <?php echo $_SESSION['system']['name'] ?> | <a href="https://1sourcecodr.blogspot.com/" target="_blank">Pelaminan Dua Saudara</a></div>
    </div>
  </footer>
