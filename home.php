    ...
    content: unset!important;
        ...
        <div >
            <div class="container mt-3 pt-2">
                <h4 class="text-center text-white">Pelaminan/Baju Adat kami</h4>
                <hr class="divider">
                <?php
                $cat = array();
                $cat[] = '';
                ...
                $cars = $conn->query("SELECT * from pelaminan ");
                if( $cars->num_rows > 0):
                ...
                <?php else: ?>
                    <div class="card mb-4">
                        <div class="card-body">Tidak ada Pelaminan/Baju Adat yang akan Disewa</div>
                    </div>
                <?php endif; ?>
