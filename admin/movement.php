					...
					<div class="card-body">
						<table class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								...
								$movements = $conn->query("SELECT bc.status as bstatus,b.*,c.model,c.brand,c.transmission_id,c.engine_id FROM borrowed bc inner join buku b on b.id = bc.booked_id inner join pelaminan c on c.id = b.car_id ");
