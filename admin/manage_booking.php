...
if(isset($_GET['id'])){
$qry = $conn->query("SELECT * FROM buku where id= ".$_GET['id']);
...
<div class="container-fluid">
	<form action="" id="manage-book">
		...
		<div class="form-group">
	        <label for="" class="control-label">Dekorasi</label>
			<select name="car_id" id="" class="custom-select select2" required>
				<option value=""></option>
				<?php
				$qry = $conn->query("SELECT * FROM pelaminan order by model asc ,brand asc ");
		...
		<div class="form-group">
	        <label for="" class="control-label">Jam/Tanggal Peminjaman</label>
	      ...
	      <div class="form-group">
	        <label for="" class="control-label">Jam/Tanggal Pengembalian</label>
		...
		<div class="form-group">
			<label for="" class="control-label">Nama Panjang</label>
		...
		<div class="form-group">
			...
			<select class="custom-select" name="status">
				<option value="1" <?php echo isset($status) && $status == 1 ? "selected" : '' ?>>Tertunda</option>
				<option value="2" <?php echo isset($status) && $status == 2 ? "selected" : '' ?>>Terkonfirmasi</option>
				<option value="2" <?php echo isset($status) && $status == 0 ? "selected" : '' ?>>Pembatalan</option>
			</select>
		</div>
	</form>
</div>
