...
<?php
if(isset($_GET['id'])){
$qry = $conn->query("SELECT * FROM pelaminan where id= ".$_GET['id']);
			...
			<div class="card-body">
				<form action="" id="manage-car">
					...
					<div class="form-group row">
						...
						<div class="col-md-4">
							<label for="" class="control-label">Tipe Dekorasi</label>
							<select class="custom-select select2" name="engine_id">
								<option value=""></option>
								<?php
								$qry = $conn->query("SELECT * FROM tipe_bajuadat order by name asc");
								while($row=$qry->fetch_assoc()):
								?>
						...
						<div class="col-md-4">
							<label for="" class="control-label">Tipe Pelaminan/Baju Adat</label>
							<select class="custom-select select2" name="transmission_id">
								<option value=""></option>
								<?php
								$qry = $conn->query("SELECT * FROM tipe_dekorasi order by name asc");
								while($row=$qry->fetch_assoc()):
								?>
					...
					<div class=" row form-group">
						<div class="col-md-5">
							<label for="" class="control-label">Gambar Pelaminan/Baju Adat</label>
