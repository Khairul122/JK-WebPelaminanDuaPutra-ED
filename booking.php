...
$qry = $conn->query("SELECT * FROM pelaminan where id= ".$_GET['car_id']);
...
<div class="container-fluid">
	<form action="" id="manage-book">
		...
		<div class="form-group">
	        <label for="" class="control-label">Tanggal/Waktu Penjemputan</label>
	      ...
	      <div class="form-group">
	        <label for="" class="control-label">Tanggal/Waktu Pengantaran</label>
